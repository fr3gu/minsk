...
namespace Minsk.ConsoleApp
{
    internal abstract class Repl
    {
        ...
        private sealed class SubmissionView
        {
            ...
            private void SubmissionDocumentChanged(object sender, NotifyCollectionChangedEventArgs args)
            {
                Render();
            }
        ...
        private void HandleEnter(ObservableCollection<string> document, SubmissionView view)
        {
            ...
            var completeSubmission = IsCompleteSubmission(submissionText);
            if (submissionText.StartsWith("#") || completeSubmission)
            {
                _done = true;
                return;
            }
        ...
        private void HandleTab(ObservableCollection<string> document, SubmissionView view)
        {
            ...
            document[lineIndex] = document[lineIndex].Insert(start, new string(' ', remainingSpaces));
        ...
        private static void WritePrompt(bool isFirst)
        {
        ...
        protected virtual void EvaluateMetaCommands(string input)
        {
